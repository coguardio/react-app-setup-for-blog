...
if [[ -f /usr/share/elasticsearch/config/certs/elasticsearch.keystore ]]
then
    cp /usr/share/elasticsearch/config/certs/elasticsearch.keystore /usr/share/elasticsearch/config/elasticsearch.keystore;
fi
